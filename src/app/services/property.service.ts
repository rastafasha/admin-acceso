...
export class PropertyService {
  ...
  private filteredProjectsSubject = new BehaviorSubject<Property[]>([]);
    public filteredProjects$: Observable<Property[]> = this.filteredProjectsSubject.asObservable();
 ...
 emitFilteredProjects(portafolios: Property[]) {
    this.filteredProjectsSubject.next(portafolios);
  }
